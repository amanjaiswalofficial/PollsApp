...
class QuestionMethods():
    ...
    def get_question_set_call(self, args_dict):
    ...
    def get_question_call(self, args_dict):
    ...
    def create_question_call(self, args_dict):
    ...
    def update_question_call(self, args_dict):
    ...
    def delete_question_call(self, args_dict):
        current_user = args_dict.pop('current_user')
        permission = args_dict.pop('permissions')[0]
        response, response_status = DBQueries().get_object_from_queryset(**args_dict)
        if response:
...
class ChoiceMethods():
    ...
    def create_choice_call(self, args_dict):
        current_user = args_dict.pop('current_user')
    ...
    def update_choice_call(self, args_dict):
        filter_values ={}
        current_user = args_dict.pop('current_user')
    ...
    def delete_choice_call(self, args_dict):
        current_user = args_dict.pop('current_user')
        choice_model = args_dict.pop('current_model')
        question_model = args_dict.pop('other_model')
        permission = args_dict.pop('permissions')[0]
    ...
    def get_choice_set_call(self, args_dict):
        choice_model = args_dict.pop('current_model')
        question_model = args_dict.pop('other_model')
...
def get_api_name(input_str):
    api_call_dictionary = {'create_question': QuestionMethods().create_question_call,
                           'get_question_set': QuestionMethods().get_question_set_call,
                           'get_question': QuestionMethods().get_question_call,
                           'update_question': QuestionMethods().update_question_call,
                           'delete_question': QuestionMethods().delete_question_call,
                           'create_choice': ChoiceMethods().create_choice_call,
                           'get_choice_set': ChoiceMethods().get_choice_set_call,
                           'update_choice': ChoiceMethods().update_choice_call,
                           'delete_choice': ChoiceMethods().delete_choice_call}
